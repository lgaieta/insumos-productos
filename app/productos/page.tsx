...
import ProductsTable from '@productos/(lib)/components/products-table/ProductsTable';
import ProductsTableErrorBoundary from '@productos/(lib)/components/products-table/ProductsTableErrorBoundary';
