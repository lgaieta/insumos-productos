...
import ProductsTable from '@productos/(lib)/ui/components/products-table/ProductsTable';
import ProductsTableErrorBoundary from '@productos/(lib)/ui/components/products-table/ProductsTableErrorBoundary';
